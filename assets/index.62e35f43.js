 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jr=new bh("@firebase/firestore");function Fp(){return Jr.logLevel}function Qb(t){Jr.setLogLevel(t)}function k(t,...e){if(Jr.logLevel<=ne.DEBUG){const n=e.map(Ug);Jr.debug(`Firestore (${Ro}): ${t}`,...n)}}function Me(t,...e){if(Jr.logLevel<=ne.ERROR){const n=e.map(Ug);Jr.error(`Firestore (${Ro}): ${t}`,...n)}}function kn(t,...e){if(Jr.logLevel<=ne.WARN){const n=e.map(Ug);Jr.warn(`Firestore (${Ro}): ${t}`,...n)}}function Ug(t){if(typeof t=="string")return t;try{return e=t,JSON.stringify(e)}catch{return t}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function pi(t){if(t.code!==_.FAILED_PRECONDITION||t.message!==pS)throw t;k("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class F0{constructor(){this.Xr=()=>this.Zr(),this.eo=()=>this.no(),this.so=[],this.io()}Yr(e){this.so.push(e)}shutdown(){window.removeEventListener("online",this.Xr),window.removeEventListener("offline",this.eo)}io(){window.addEventListener("online",this.Xr),window.addEventListener("offline",this.eo)}Zr(){k("ConnectivityMonitor","Network connectivity changed: AVAILABLE");for(const e of this.so)e(0)}no(){k("ConnectivityMonitor","Network connectivity changed: UNAVAILABLE");for(const e of this.so)e(1)}static D(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wt="WebChannelConnection";class XP extends class{constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const n=e.ssl?"https":"http";this.mo=n+"://"+e.host,this.yo="projects/"+this.databaseId.projectId+"/databases/"+this.databaseId.database+"/documents"}get po(){return!1}Io(e,n,r,i,s){const o=yf(),a=this.To(e,n);k("RestConnection",`Sending RPC '${e}' ${o}:`,a,r);const l={};return this.Eo(l,i,s),this.Ao(e,a,l,r).then(u=>(k("RestConnection",`Received RPC '${e}' ${o}: `,u),u),u=>{throw kn("RestConnection",`RPC '${e}' ${o} failed with error: `,u,"url: ",a,"request:",r),u})}vo(e,n,r,i,s,o){return this.Io(e,n,r,i,s)}Eo(e,n,r){e["X-Goog-Api-Client"]="gl-js/ fire/"+Ro,e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),n&&n.headers.forEach((i,s)=>e[s]=i),r&&r.headers.forEach((i,s)=>e[s]=i)}To(e,n){const r=QP[e];return`${this.mo}/v1/${n}:${r}`}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Ao(e,n,r,i){const s=yf();return new Promise((o,a)=>{const l=new Hb;l.setWithCredentials(!0),l.listenOnce(qb.COMPLETE,()=>{try{switch(l.getLastErrorCode()){case df.NO_ERROR:const c=l.getResponseJson();k(wt,`XHR for RPC '${e}' ${s} received:`,JSON.stringify(c)),o(c);break;case df.TIMEOUT:k(wt,`RPC '${e}' ${s} timed out`),a(new T(_.DEADLINE_EXCEEDED,"Request time out"));break;case df.HTTP_ERROR:const h=l.getStatus();if(k(wt,`RPC '${e}' ${s} failed with status:`,h,"response text:",l.getResponseText()),h>0){let d=l.getResponseJson();Array.isArray(d)&&(d=d[0]);const p=d==null?void 0:d.error;if(p&&p.status&&p.message){const y=function(v){const C=v.toLowerCase().replace(/_/g,"-");return Object.values(_).indexOf(C)>=0?C:_.UNKNOWN}(p.status);a(new T(y,p.message))}else a(new T(_.UNKNOWN,"Server responded with status "+l.getStatus()))}else a(new T(_.UNAVAILABLE,"Connection failed."));break;default:$()}}finally{k(wt,`RPC '${e}' ${s} completed.`)}});const u=JSON.stringify(i);k(wt,`RPC '${e}' ${s} sending request:`,i),l.send(n,"POST",u,r,15)})}Ro(e,n,r){const i=yf(),s=[this.mo,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=Bb(),a=jb(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},u=this.longPollingOptions.timeoutSeconds;u!==void 0&&(l.longPollingTimeout=Math.round(1e3*u)),this.useFetchStreams&&(l.xmlHttpFactory=new Gb({})),this.Eo(l.initMessageHeaders,n,r),l.encodeInitMessageHeaders=!0;const c=s.join("");k(wt,`Creating RPC '${e}' stream ${i}: ${c}`,l);const h=o.createWebChannel(c,l);let d=!1,p=!1;const y=new YP({ro:C=>{p?k(wt,`Not sending because RPC '${e}' stream ${i} is closed:`,C):(d||(k(wt,`Opening RPC '${e}' stream ${i} transport.`),h.open(),d=!0),k(wt,`RPC '${e}' stream ${i} sending:`,C),h.send(C))},oo:()=>h.close()}),v=(C,g,f)=>{C.listen(g,m=>{try{f(m)}catch(I){setTimeout(()=>{throw I},0)}})};return v(h,$u.EventType.OPEN,()=>{p||k(wt,`RPC '${e}' stream ${i} transport opened.`)}),v(h,$u.EventType.CLOSE,()=>{p||(p=!0,k(wt,`RPC '${e}' stream ${i} transport closed`),y.wo())}),v(h,$u.EventType.ERROR,C=>{p||(p=!0,kn(wt,`RPC '${e}' stream ${i} transport errored:`,C),y.wo(new T(_.UNAVAILABLE,"The operation could not be completed")))}),v(h,$u.EventType.MESSAGE,C=>{var g;if(!p){const f=C.data[0];z(!!f);const m=f,I=m.error||((g=m[0])===null||g===void 0?void 0:g.error);if(I){k(wt,`RPC '${e}' stream ${i} received error:`,I);const E=I.status;let N=function(U){const oe=Ve[U];if(oe!==void 0)return QS(oe)}(E),R=I.message;N===void 0&&(N=_.INTERNAL,R="Unknown error status: "+E+" with message "+I.message),p=!0,y.wo(new T(N,R)),h.close()}else k(wt,`RPC '${e}' stream ${i} received:`,f),y._o(f)}}),v(a,Wb.STAT_EVENT,C=>{C.stat===Gw.PROXY?k(wt,`RPC '${e}' stream ${i} detected buffering proxy`):C.stat===Gw.NOPROXY&&k(wt,`RPC '${e}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{y.fo()},0),y}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
